...
public class ChemSpiderClient {
     ...
     */
    public String getChemicalStructuresByMass(Double mass, Double error,String location) throws RemoteException {
        ...
        String sdfPath = getChemicalStructuresByCsids(Output,location);
     ...
     * @throws RemoteException
     */
    public String getChemicalStructuresByCsids(int[] _csids,String location) throws RemoteException {
     ...
     */
    protected String downloadCompressedSDF(String rid, MassSpecAPIStub stub ,String location) {
