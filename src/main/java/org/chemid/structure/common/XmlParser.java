...
public class XmlParser {
    ...
    public static Document StringToXML(String xmlRecords) throws Exception {
    ...
    public static Document getXMLPayload(String fileName, String location) throws Exception {
...
//        URL url = Thread.currentThread().getContextClassLoader().getResource(location + fileName);
        ...
        Document doc = dBuilder.parse(new File(resource.getPath()));
        return doc;
    }
